...
for n in rotor_l:
	...
	print "zeta1:",zeta1_list
	print "zeta2:",zeta2_list
	...
	turbo.listRows[n].listProfiles[0].weightCondition=5	# =0 parabel, =1 kub. parabel, =2 tangens, =3 arcsin, =4 gerade
	turbo.listRows[n].listProfiles[0].weightCombination=2	# =0 curvature of polynom, =1 curvature of polynomial part, =2 div weight funct, =3 combination of polynomial & other 
	...
	turbo.listRows[n].listProfiles[0].flagThickDistr=1 #=0 no profile; =1 polynomial; =2 NURBS; =3 doubleCircArc profile
	...
	turbo.listRows[n].listProfiles[1].weightCondition=5	# =0 parabel, =1 kub. parabel, =2 tangens, =3 arcsin, =4 gerade
	turbo.listRows[n].listProfiles[1].weightCombination=2	# =0 curvature of polynom, =1 curvature of polynomial part, =2 div weight funct, =3 combination of polynomial & other 
	...
	turbo.listRows[n].listProfiles[1].flagThickDistr=1 #=0 no profile; =1 polynomial; =2 NURBS; =3 doubleCircArc profile
	...
	turbo.listRows[n].listProfiles[2].weightCondition=5	# =0 parabel, =1 kub. parabel, =2 tangens, =3 arcsin, =4 gerade
	turbo.listRows[n].listProfiles[2].weightCombination=2	# =0 curvature of polynom, =1 curvature of polynomial part, =2 div weight funct, =3 combination of polynomial & other 
	...
	turbo.listRows[n].listProfiles[2].flagThickDistr=1 #=0 no profile; =1 polynomial; =2 NURBS; =3 doubleCircArc profile
	...
	turbo.listRows[n].listProfiles[3].weightCondition=5	# =0 parabel, =1 kub. parabel, =2 tangens, =3 arcsin, =4 gerade
	turbo.listRows[n].listProfiles[3].weightCombination=2	# =0 curvature of polynom, =1 curvature of polynomial part, =2 div weight funct, =3 combination of polynomial & other 
	...
	turbo.listRows[n].listProfiles[3].flagThickDistr=1 #=0 no profile; =1 polynomial; =2 NURBS; =3 doubleCircArc profile
	...
	turbo.listRows[n].listProfiles[4].weightCondition=5	# =0 parabel, =1 kub. parabel, =2 tangens, =3 arcsin, =4 gerade
	turbo.listRows[n].listProfiles[4].weightCombination=2	# =0 curvature of polynom, =1 curvature of polynomial part, =2 div weight funct, =3 combination of polynomial & other 
	...
	turbo.listRows[n].listProfiles[4].flagThickDistr=1 #=0 no profile; =1 polynomial; =2 NURBS; =3 doubleCircArc profile
